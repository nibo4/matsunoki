...
import type { SignUpResponse, SignUpError, UnknownError, SignUp } from '@matsunoki/api-client'
import {Ok, Result} from "ts-results";

export const signUpUserActionSubject = new Subject<Result<SignUpResponse, SignUpError | UnknownError>>()
...
export const signUpUserAction = (deps: SignUpUserActionDependencies) => async (): Promise<void> => {
